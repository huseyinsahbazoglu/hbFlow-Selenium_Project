...
public class TestSuiteChrome {
    ...
    @BeforeTest (groups = {"SolutionCenterTest","runChromeTest"})
    ...
    @Test (priority = 1, suiteName = "Hepsi BuradaTestSuite", testName = "I Have Questions About My Order Test", groups = {"SolutionCenterTest", "runChromeTest"})
    public static void productionsPage() throws IOException {
    ...
    @Test (priority = 2, suiteName = "HepsiBuradaTestSuite", testName = "Select an Order and Reach Chat Page Test", groups = {"SolutionCenterTest", "runChromeTest"})
    ...
    @Test (priority = 3, suiteName = "HepsiBuradaTestSuite", testName = "SSS Page Test", groups = {"SolutionCenterTest", "runChromeTest"})
    ...
    @Test (priority = 4, suiteName = "HepsiBuradaTestSuite", testName = "Call Request to Inquire About an Order Test", groups = {"SolutionCenterTest", "runChromeTest"})
    ...
    public void afterMethod(ITestResult result) {
        if(result.getStatus() == ITestResult.FAILURE) {
            ...
            try {
                ...
                FileUtils.copyFile(screenshotFile, new File(".//screenshot/chrome//" + result.getMethod().getMethodName() + " Test Failed_" +fileSuffix+ ".png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    @AfterSuite (groups = {"SolutionCenterTest", "runChromeTest"})
